...
export default function WelcomeToLinkist() {
  ...
  return (
    <>
      <div className="bg-gray-50 flex items-center justify-center py-20 px-4 min-h-screen overflow-x-hidden">
        <div className="bg-white rounded-none sm:rounded-2xl shadow-xl max-w-3xl w-full p-4 sm:p-6 mb-8 overflow-hidden">
        {/* Title */}
