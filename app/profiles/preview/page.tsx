    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          {/* Background Image with Founder's Club Badge */}
          <div className="relative">
            ...
            {/* Founder's Club Badge - Positioned on background image */}
            {profileData.isFoundingMember && (
              <div className="absolute top-2 right-2 sm:top-3 sm:right-3 z-20">
                <div className="inline-flex items-center bg-gradient-to-r from-yellow-400 to-amber-500 text-black px-2 sm:px-3 py-1 sm:py-1.5 rounded-full shadow-lg">
