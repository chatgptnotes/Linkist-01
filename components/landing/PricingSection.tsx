    ...
    <section id="pricing" className="relative pt-12 pb-12 bg-[#050505] overflow-visible">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="mb-6 text-center text-[28px] leading-[36px] min-[390px]:text-[32px] min-[390px]:leading-[43px] md:text-[56px] md:leading-[72px] font-inter font-medium tracking-[-0.04em]"
          style={{
