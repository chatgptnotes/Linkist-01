      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-[#F5F7FA]">Privacy Policy</h1>
          </div>
        ...
        <div className="bg-[#0A0A0A] rounded-xl shadow-sm border border-gray-800 p-8 space-y-8">
          ...
          {/* Introduction */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Introduction</h2>
          ...
          {/* Data We Collect */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Information We Collect</h2>
            
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-[#F5F7FA] mb-2">Personal Information</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-[#F5F7FA] mb-2">Technical Information</h3>
                <ul className="list-disc list-inside text-gray-300 space-y-1">
              ...
              <div>
                <h3 className="text-lg font-medium text-[#F5F7FA] mb-2">Order Information</h3>
                <ul className="list-disc list-inside text-gray-300 space-y-1">
          ...
          {/* How We Use Data */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">How We Use Your Information</h2>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-3">
                <Mail className="w-6 h-6 text-red-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-medium text-[#F5F7FA] mb-1">Service Delivery</h3>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-[#F5F7FA] mb-1">Analytics</h3>
                  <p className="text-sm text-gray-300">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-[#F5F7FA] mb-1">Communication</h3>
                  <p className="text-sm text-gray-300">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-[#F5F7FA] mb-1">Security</h3>
                  <p className="text-sm text-gray-300">
          ...
          {/* Legal Basis */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Legal Basis for Processing</h2>
          ...
          {/* Data Sharing */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Data Sharing and Third Parties</h2>
            <div className="space-y-4">
              <p className="text-gray-300">
                We do not sell your personal data. We only share information with trusted partners who help us provide our services:
              </p>
              
              <div className="bg-[#151515] rounded-lg p-4 space-y-2 text-gray-300">
          ...
          {/* Data Security */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Data Security</h2>
            <div className="space-y-3 text-gray-300">
          ...
          {/* Your Rights */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Your Privacy Rights</h2>
            
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-red-950/30 border border-red-900/30 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  <Download className="w-5 h-5 text-red-400" />
                  <h3 className="font-medium text-red-300">Access & Portability</h3>
                </div>
              ...
              <div className="bg-red-950/30 border border-red-900/30 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h3 className="font-medium text-red-300">Deletion</h3>
                </div>
                <p className="text-sm text-red-200/80">
              ...
              <div className="bg-green-950/30 border border-green-900/30 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h3 className="font-medium text-green-300">Rectification</h3>
                </div>
              ...
              <div className="bg-purple-950/30 border border-purple-900/30 rounded-lg p-4">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <h3 className="font-medium text-purple-300">Objection</h3>
                </div>
            ...
            <div className="mt-4 p-4 bg-[#151515] rounded-lg">
              <p className="text-sm text-gray-300">
                <strong>To exercise these rights:</strong> Contact us at{' '}
                <a href="mailto:privacy@linkist.ai" className="text-red-400 hover:text-red-300">
                  privacy@linkist.ai
                </a>{' '}
                or use our{' '}
                <Link href="/privacy/manage" className="text-red-400 hover:text-red-300">
          ...
          {/* Cookies */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Cookies and Tracking</h2>
            <div className="space-y-3 text-gray-300">
          ...
          {/* Data Retention */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Data Retention</h2>
            <div className="space-y-3 text-gray-300">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">International Data Transfers</h2>
            <p className="text-gray-300">
          ...
          {/* Children's Privacy */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Children's Privacy</h2>
            <p className="text-gray-300">
          ...
          {/* Changes to Policy */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Policy Updates</h2>
            <p className="text-gray-300">
          ...
          {/* Contact Information */}
          <section>
            <h2 className="text-2xl font-semibold text-[#F5F7FA] mb-4">Contact Us</h2>
